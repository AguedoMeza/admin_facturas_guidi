...
font-size: 20px;"> <center>HOTEL GUIDI LINARES | DEPARTAMENTO DE SISTEMAS | JOSE AGUEDO SERNA MEZA</center> </div><div style="float: right; padding: 15px 50px 5px 50px;"><a href="../login/cerrarsesion.php" class="btn btn-danger square-btn-adjust" style="background-color: #095219">Salir</a> </div></div>
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                     <h2 class="h2a">LISTA DE CUENTAS X PAGAR PENDIENTES<div style="font-size: 20px;" class="pull-right">Bienvenido: Orlando Cardenas</div></h2>  
                    </div>
                </div>
  ...
  <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
          ...
          <form method="post" action="excel_pendientes.php">
             <input type="submit" name="export" class="btn btn-success" value="Exportar a Excel" />
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-6 col-md-2 col-lg-12">	
						<!-- inicio tabla -->
         <?php
          include("lista_cuentas_pendientes.php");
          ?>
            <!-- fin tabla -->
            <div class="form-group">
